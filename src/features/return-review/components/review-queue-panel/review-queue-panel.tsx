              ...
              {isReviewed(field) ? (
                ...
                <button
                  ...
                  className={cn(
                    ...
                    "hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-card cursor-pointer",
                  )}
                >
                  Review
                </button>
